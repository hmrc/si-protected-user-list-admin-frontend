...
final case class Edit404Scenario(strideUserPID: String, entryID: String, update: Update) extends AbstractScenario(Seq.empty)

object Edit404Scenario extends Generators {
  implicit val arb: Arbitrary[Edit404Scenario] = Arbitrary(
    for {
